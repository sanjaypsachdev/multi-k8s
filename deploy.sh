...
kubectl set image deployments/client-deployment client=sanjaypsachdev/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=sanjaypsachdev/multi-worker:$SHA